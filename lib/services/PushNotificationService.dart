...
// Also handle any interaction when the app is in the background via a
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      ...
      print("OpenedApp == ${message.data.toString()}");
    //  _handleMessageClick(message);

       /* if (message.data['key'] == 'accepted') {
        //id
      }*/
    });
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      if (message.notification != null) {
        print("Foreground Notification Clicked: ${message.notification!.title}");
  ...
  registerNotificationListeners() async {
    ...
    var androidSettings =
        const AndroidInitializationSettings('@mipmap/ic_launcher_logo');
    ...
    flutterLocalNotificationsPlugin.initialize(initSetttings,
        onDidReceiveNotificationResponse: (message) async {
          ...
          print("🔔 Foreground Notification Clicked: ${message.payload}");
          print("🔔 Foreground Notification Clicked: ${message.notificationResponseType.name}");
...
// If `onMessage` is triggered with a notification, construct our own
    ...
    if (screen == 'Parcel Added') {
     // navigatorKey.currentState?.push(MaterialPageRoute(builder: (context) => const Notifications()));
      /*if (Get.isRegistered<GetMaterialApp>()) {
        ...
        print("Navigation attempted without GetMaterialApp context.");
      }*/
  ...
  static void _handleMessageClick(RemoteMessage message) {
    print("📩 Handel Notification: ${message.data}");

    /*if (message.data.containsKey('notification_type')) {
      String screen = message.data['notification_type'];
